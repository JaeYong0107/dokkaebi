...
export const seedCategoriesData: CategorySeed[] = [
  {
    id: "all",
    name: "전체보기",
    icon: "grid_view",
  ...
  },
  {
    ...
    name: "가공식품",
    icon: "inventory_2",
    productCategories: ["공산품"],
    featured: false
  }
];

export const seedProductsData: ProductSeed[] = [
  {
    id: "prod-lettuce-001",
    sku: "DKB-VG-001",
    name: "무농약 버터헤드 레터스 1kg",
    description: "경상북도 청도군 덕산 농장에서 30년째 무농약 수경재배로 길러낸 버터헤드입니다.",
    category: "채소",
    unit: "1kg / 봉",
    basePrice: 18500,
  ...
  },
  {
    ...
    basePrice: 32000,
    normalDiscountRate: 0,
    businessDiscountRate: 22.19,
    origin: "전북 고창",
    imageUrl:
      "https://images.pexels.com/photos/25482631/pexels-photo-25482631.jpeg?cs=srgb&dl=pexels-marcio-carvalho-1334537412-25482631.jpg&fm=jpg",
    imageEmoji: "🍉",
  ...
  },
  {
    ...
    basePrice: 14500,
    normalDiscountRate: 0,
    businessDiscountRate: 14.48,
    origin: "미국",
    imageUrl:
      "https://images.pexels.com/photos/34543890/pexels-photo-34543890.jpeg?cs=srgb&dl=pexels-yigit-can-ozay-2156561837-34543890.jpg&fm=jpg",
    imageEmoji: "🍋",
  ...
  },
  {
    ...
    basePrice: 21000,
    normalDiscountRate: 0,
    businessDiscountRate: 11.9,
    origin: "충북 음성",
    imageUrl:
      "https://images.pexels.com/photos/6845799/pexels-photo-6845799.jpeg?cs=srgb&dl=pexels-tima-miroshnichenko-6845799.jpg&fm=jpg",
    imageEmoji: "🥚",
  ...
  },
  {
    ...
    basePrice: 25900,
    normalDiscountRate: 0,
    businessDiscountRate: 11.97,
    origin: "국산",
    imageUrl:
      "https://images.pexels.com/photos/112781/pexels-photo-112781.jpeg?cs=srgb&dl=pexels-markusspiske-112781.jpg&fm=jpg",
    imageEmoji: "🥩",
  ...
  },
  {
    ...
    basePrice: 6500,
    normalDiscountRate: 0,
    businessDiscountRate: 9.23,
    origin: "국내 제조",
    imageUrl:
      "https://images.pexels.com/photos/8504692/pexels-photo-8504692.jpeg?cs=srgb&dl=pexels-hergafi-8504692.jpg&fm=jpg",
    imageEmoji: "🫒",
  ...
  },
  {
    ...
    basePrice: 15000,
    normalDiscountRate: 0,
    businessDiscountRate: 23.33,
    origin: "경상북도 의성",
    imageUrl:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuDUFgN-BXmNZhidLoJwU8PWDCfXyD1ngT8ULhclbT3MRFQQ_FzOfWrqOo4PJb2kwp4FWJ9PC0LZySTLKATfmh4OcypnfnN3bAVhNm7zcF7_BtnU2IwzHuxS7yk7m8q6YFcS6xcAF-nymECkwtTv7pbpFivtKrr68Mrk-nQefBx6woAeOpgUhf1gql6rSZ-izKAZkxSM_G6pWk8Bcd_tYB2s5rOPnaAxy0icdV_Lyg3qFZQ9Zd-ideMI9DC3iK0eAB02DrRSLQQv8yk",
    imageEmoji: "🧄",
    imageBg: "from-stone-100 to-stone-300",
    badges: ["신선보장"],
    isActive: true,
